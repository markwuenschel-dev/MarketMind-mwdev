"""Integration test for the OI-59 Experiment 3 boundary-treatment CLI."""
...
def test_run_oi59_boundary_treatment_emits_required_artifacts(
    tmp_path: Path, deterministic_seed: int
) -> None:
    _ = deterministic_seed
    from scripts.run_oi59_boundary_treatment import run_oi59_boundary_treatment
    ...
    report = run_oi59_boundary_treatment(
    ...
    assert (tmp_path / "out" / "oi59_boundary_treatment_report.json").exists()
    assert (tmp_path / "out" / "oi59_boundary_treatment_diagnostic.md").exists()
